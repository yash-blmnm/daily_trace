    ...
    return <header>
        <div className='flex flex-row justify-center items-center  w-full py-4 px-2'>
            ...
            <nav className='flex flex-row justify-self-end basis-1/4 gap-2'>
                <div className='text-sm hover:text-gray-800 hover:font-bold cursor-pointer'>Add Goal</div>
                <div className='text-sm hover:text-gray-800 hover:font-bold cursor-pointer'>Account</div>
            </nav>
        </div>
    </header>
}
